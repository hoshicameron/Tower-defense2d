...
namespace GameSystemsCookbook
{
    ...
    public abstract class GenericEventChannelSOEditor<T> : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var spaceElement = new VisualElement { style = { marginBottom = 20 } };
            root.Add(spaceElement);

            // Add a label
            m_ListenersLabel = new Label { text = "Listeners:", style = { borderBottomWidth = 1, borderBottomColor = Color.grey, marginBottom = 2 } };
            ...
            m_RaiseEventButton = new Button { text = "Raise Event" };
            m_RaiseEventButton.RegisterCallback<ClickEvent>(_ => m_EventChannel.RaiseEvent(default));
        ...
        private void BindItem(VisualElement element, int index)
        {
            ...
            var label = (Label)element.ElementAt(0);
